...
- 논리형은 별도로 있지 않지만, 정수형(int)으로 간주됩니다. (1:참, 0:거짓)
*/
...
int main(void)
{
  ...
  unsigned char: 1byte (0 ~ 128 + 127)
  unsigned short: 2byte (0 ~ 32768 + 32767)
  unsigned int: 4byte (0 ~ 2147483648 + 2147483647)
  unsigned long: 4byte (0 ~ -2147483648 + 2147483647)
  unsigned long long: 8byte (0 ~ 9223372036854775808 + 9223372036854775807)
  ...
  */
  ...
  /*
  [논리형]
  - c는 1(0이 아닌 값)은 참, 0은 거짓으로 판단합니다.
  - 문자(literal)는 '', 문자열(literal)은 ""로 만듭니다.
  - 문자열은 char의 배열입니다.
  */
  printf("=== 논리형 ===\n");
  printf("ch의 byte는 %d %lu \n", 3 > 1, sizeof(3 > 1));
  if (1)
  {
    printf("1은 참입니다.\n");
  }
